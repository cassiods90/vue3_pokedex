<template>
    <svg width="130" height="115" viewBox="0 0 130 115" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
            ...
            fill="url(#paint0_linear_268_1083)"
        />
        <path
            ...
            fill="url(#paint1_linear_268_1083)"
        />
        <path
            ...
            fill="url(#paint2_linear_268_1083)"
        />
        <defs>
            <linearGradient id="paint0_linear_268_1083" x1="72.5" y1="-15" x2="72.5" y2="130" gradientUnits="userSpaceOnUse">
                <stop stop-color="white" stop-opacity="0.3" />
                <stop offset="1" stop-color="white" stop-opacity="0" />
            </linearGradient>
            <linearGradient id="paint1_linear_268_1083" x1="72.5" y1="-15" x2="72.5" y2="130" gradientUnits="userSpaceOnUse">
                <stop stop-color="white" stop-opacity="0.3" />
                <stop offset="1" stop-color="white" stop-opacity="0" />
            </linearGradient>
            <linearGradient id="paint2_linear_268_1083" x1="72.5" y1="-15" x2="72.5" y2="130" gradientUnits="userSpaceOnUse">
                <stop stop-color="white" stop-opacity="0.3" />
                <stop offset="1" stop-color="white" stop-opacity="0" />
            </linearGradient>
        </defs>
